			...
			<section className="features-head bg-primary py-3">
				<div className="container grid">
					<div>
						...
						<p className="lead">Check out the features of Loruki that separate us from the competition</p>
					</div>
					<img src={server} alt="sever1" />
				</div>
			</section>
			...
			<section className="features-sub-head bg-light py-3">
				<div className="container grid">
					<div>
						...
						<p>
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor cupiditate dignissimos temporibus perspiciatis quae! Suscipit qui, consectetur ea consequatur, doloribus
							repellendus quasi, aut corporis nam alias culpa. Nostrum, inventore accusantium!
						</p>
					</div>
			...
			<section className="features-main my-2">
				<div className="container grid grid-3">
					<div className="card flex">
						...
						<p>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas nemo saepe corrupti et dolorem voluptate at, nostrum rem voluptatem ab alias quia molestiae ea, libero
